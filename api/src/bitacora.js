...
const MAPA = {
  ...
  'bandejas/{codigo}/fotos':                     { p:'Bandejas',            POST:'Subió una foto de la bandeja' },
  'bandejas/{codigo}/fotos/{fid}':               { p:'Bandejas',            PUT:'Renombró o reordenó una foto de la bandeja',
                                                                            DELETE:'Borró una foto de la bandeja' },
